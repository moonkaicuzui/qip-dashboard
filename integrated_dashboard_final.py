...
<head>
    ...
    <style>
        ...
        * {{
        ...
        .tab-content {{
            display: none;
            visibility: hidden;  /* 접근성 트리에서 숨김 - Bug 2 fix */
            background: white;
            padding: 30px;
            border-radius: 12px;
            box-shadow: 0 4px 6px rgba(0,0,0,0.07);
        ...
        .tab-content.active {{
            display: block;
            visibility: visible;  /* 활성 탭은 접근성 트리에 표시 */
        }}
        ...
        /* Complete redesign for mobile UX - 2025-12-19       */
        /* ================================================== */
        ...
        /* Control bar: Reposition from absolute to flex row */
        body.mobile-mode .header > div[style*="position: absolute"] {{
            position: relative !important;
            top: auto !important;
        ...
        /* Shrink select dropdowns on mobile */
        body.mobile-mode .header select.form-select {{
            width: 100px !important;
            font-size: 0.8rem !important;
            padding: 6px 8px !important;
        }}

        /* Shrink buttons on mobile - icon only */
        body.mobile-mode .header .btn {{
        ...
        /* Data freshness badge compact */
        body.mobile-mode #dataFreshnessBadge {{
        ...
        body.mobile-mode .report-type-banner {{
            padding: 10px !important;
            flex-direction: column !important;
            gap: 8px !important;
        }}
        body.mobile-mode .report-type-banner .message .title {{
            font-size: 0.95rem !important;
        }}
        body.mobile-mode .report-type-banner .message .description {{
            font-size: 0.8rem !important;
        }}
        ...
        /* ====== MOBILE ORG WRAPPER VISIBILITY ====== */
        .mobile-org-wrapper {{
            display: none;
        }}

        body.mobile-mode .mobile-org-wrapper {{
            display: block !important;
            padding: 15px;
        }}

        /* ====== MOBILE TABLE SCROLL HINTS ====== */
        body.mobile-mode .table-scroll-wrapper {{
            position: relative;
            overflow-x: auto;
            -webkit-overflow-scrolling: touch;
        }}

        body.mobile-mode .table-scroll-wrapper::after {{
            content: '→ 스크롤';
            position: absolute;
            top: 50%;
            right: 10px;
        ...
        /* ====== MOBILE MODAL TABLES - CARD STYLE ====== */
        body.mobile-mode .modal-body .table {{
            min-width: auto !important;
        }}

        /* Convert modal tables to card-like rows on mobile */
        body.mobile-mode .modal-table-mobile {{
            display: block;
        }}

        body.mobile-mode .modal-table-mobile thead {{
            display: none;
        }}

        body.mobile-mode .modal-table-mobile tbody tr {{
            display: block;
            margin-bottom: 12px;
            padding: 12px;
            background: #f8f9fa;
        ...
        body.mobile-mode .modal-table-mobile tbody tr:nth-child(odd) {{
            border-left-color: #28a745;
        }}

        body.mobile-mode .modal-table-mobile tbody td {{
            display: flex;
            justify-content: space-between;
        ...
        body.mobile-mode .modal-table-mobile tbody td::before {{
        ...
        /* ====== MOBILE POSITION/INCENTIVE CRITERIA TABLE ====== */
        body.mobile-mode .incentive-criteria-table,
        body.mobile-mode .position-table {{
            display: block;
            overflow-x: auto;
            -webkit-overflow-scrolling: touch;
        }}

        body.mobile-mode .incentive-criteria-table table,
        body.mobile-mode .position-table table {{
            min-width: 600px;
            font-size: 0.85rem !important;
        }}

        body.mobile-mode .incentive-criteria-table th,
        body.mobile-mode .incentive-criteria-table td,
        body.mobile-mode .position-table th,
        body.mobile-mode .position-table td {{
            padding: 8px 6px !important;
            white-space: nowrap;
        }}

        /* ====== 5PRS/AQL MODAL MOBILE OPTIMIZATION ====== */
        body.mobile-mode #aqlModal .modal-body,
        body.mobile-mode #fivePrsModal .modal-body {{
            padding: 10px !important;
        }}

        body.mobile-mode #aqlModal .table,
        body.mobile-mode #fivePrsModal .table {{
            font-size: 0.85rem !important;
        }}

        body.mobile-mode #aqlModal .table th,
        body.mobile-mode #aqlModal .table td,
        body.mobile-mode #fivePrsModal .table th,
        body.mobile-mode #fivePrsModal .table td {{
            padding: 6px 4px !important;
        }}

        /* ====== MOBILE INSTRUCTIONS COLLAPSE ====== */
        body.mobile-mode .org-instructions {{
            font-size: 0.85rem !important;
            padding: 10px !important;
        }}

        body.mobile-mode .org-instructions ul {{
            margin-bottom: 5px !important;
        }}

        body.mobile-mode .org-instructions li {{
            margin-bottom: 3px !important;
        }}

        /* Collapsible instructions on mobile */
        body.mobile-mode .instructions-collapsible {{
            max-height: 80px;
            overflow: hidden;
            position: relative;
        }}

        body.mobile-mode .instructions-collapsible.expanded {{
            max-height: none;
        }}

        body.mobile-mode .instructions-collapsible::after {{
            content: '더보기 ▼';
            position: absolute;
            bottom: 0;
            left: 0;
        ...
        body.mobile-mode .instructions-collapsible.expanded::after {{
            display: none;
        }}

        /* ====== MOBILE FILTER CONTROLS COMPACT ====== */
        body.mobile-mode .filter-row {{
            flex-direction: column;
            gap: 8px;
        }}

        body.mobile-mode .filter-row select,
        body.mobile-mode .filter-row input {{
            width: 100% !important;
            font-size: 0.9rem !important;
            padding: 10px !important;
        }}

        body.mobile-mode .filter-row .btn {{
            width: 100% !important;
        }}

        /* ====== MOBILE LEGEND COMPACT ====== */
        body.mobile-mode .org-legend {{
            flex-wrap: wrap !important;
            gap: 8px !important;
            padding: 10px !important;
            font-size: 0.8rem !important;
        ...
        /* ============================================== */
        /* 🎨 모바일 UI/UX 포괄적 최적화 (2025-12-19)     */
        /* ============================================== */

        /* 📌 1. 기본 반응형 설정 및 한글/베트남어 지원 */
        html {{
            font-size: 16px;
        ...
        @media (max-width: 576px) {{
            ...
            /* 테이블 카드 변환 - 모바일 세로 */
            .mobile-card-table,
            body.mobile-mode .table-as-cards {{
                border: 0;
            }}

            .mobile-card-table thead,
            body.mobile-mode .table-as-cards thead {{
                position: absolute;
                top: -9999px;
                left: -9999px;
            }}
            ...
            body.mobile-mode .table-as-cards tr {{
                display: block;
                margin-bottom: 1rem;
            ...
            body.mobile-mode .table-as-cards td {{
                display: flex;
                justify-content: space-between;
                align-items: center;
                border: none;
            ...
            body.mobile-mode .table-as-cards td:last-child {{
                border-bottom: none;
            }}

            .mobile-card-table td::before,
            body.mobile-mode .table-as-cards td::before {{
                content: attr(data-label);
                font-weight: 600;
                color: #495057;
                flex-shrink: 0;
        ...
        @media (max-width: 992px) {{
            ...
            /* 필터 영역 2열 */
            .filter-container .row > [class*="col-"] {{
                flex: 0 0 50%;
                max-width: 50%;
                margin-bottom: 10px;
            }}
        ...
        /* 📌 4. 터치 인터페이스 최적화 (44px 최소 타겟) */
        @media (max-width: 768px) {{
            /* Apple HIG 권장 44x44px 터치 타겟 */
            .btn,
        ...
        body.mobile-mode .mobile-filter-toggle {{
            display: block;
            margin-bottom: 15px;
        }}

        body.mobile-mode .filter-panel {{
            max-height: 0;
            overflow: hidden;
            transition: max-height 0.3s ease;
        }}

        body.mobile-mode .filter-panel.show {{
            max-height: 500px;
        }}
        ...
        body.mobile-mode .scroll-indicator:hover::after,
        body.mobile-mode .scroll-indicator:focus-within::after {{
            opacity: 1;
        }}
        ...
        /* 📌 13. 로딩 스피너 모바일 */
        body.mobile-mode .loading-overlay {{
...
<body>
                        ...
                        <div class="faq-container">
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion1">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q1. 왜 나는 incentive를 못 받았나요? 조건을 확인하는 방법은?
                                </div>
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion3">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q3. TYPE-2 직급의 incentive는 어떻게 calculation되나요?
                                </div>
                                <div class="faq-answer">
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion4">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q4. ASSEMBLY INSPECTOR의 연속 work 개월은 어떻게 calculation되나요?
                                </div>
                                <div class="faq-answer">
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion5">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q5. AQL failed가 무엇이고 어떤 영향을 미치나요?
                                </div>
                                <div class="faq-answer">
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion6">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q6. 5PRS 검사량이 부족하면 어떻게 되나요?
                                </div>
                                <div class="faq-answer">
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion7">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q7. 출산휴가나 병가 중에도 incentive를 받을 count 있나요?
                                </div>
                                <div class="faq-answer">
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion8">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q8. 전month incentive와 차이가 나는 이유는 무엇인가요?
                                </div>
                                <div class="faq-answer">
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion9">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q9. TYPE-3에서 TYPE-2로 승진하면 incentive가 어떻게 변하나요?
                                </div>
                                <div class="faq-answer">
                                    <ul>
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion10">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q10. 조건을 모두 충족했는데도 incentive가 0인 이유는 무엇인가요?
                                </div>
                                <div class="faq-answer">
                            ...
                            <div class="faq-item">
                                <div class="faq-question" onclick="toggleFAQ(this)" id="faqQuestion11">
                                    <span aria-hidden="true" class="faq-icon">▶</span> Q11. TYPE-2 GROUP LEADER가 incentive를 못 받는 경우가 있나요?
                                </div>
                                <div class="faq-answer">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="orgChartContainer" class="collapsible-tree">
                            ...
                            <!-- 사용 안내 (모바일에서 접이식) -->
                            <div class="alert alert-info mb-3 org-instructions instructions-collapsible" role="alert" style="background: linear-gradient(135deg, #ef444415 0%, #dc262615 100%); border-left: 4px solid #6366f1;" onclick="this.classList.toggle('expanded')">
                                <i class="fas fa-info-circle me-2"></i>
        ...
        */
        ...
        function generateMobileOrgChart() {{
            ...
            managers.sort((a, b) => {{
                ...
                const orderA = positionOrder[Object.keys(positionOrder).find(k => posA.includes(k))] || 99;
            ...
            managers.forEach(manager => {{
                    ...
                    <div class="org-manager-card ${{isPaid ? 'paid' : 'unpaid'}}" data-manager-id="${{mgrNo}}">
                        <div class="org-card-header" onclick="toggleOrgCard(this.parentElement)">
                            <div class="org-card-info">
                                ...
                                <div class="org-card-position">${{mgrPosition}} ${{subCount > 0 ? '(👥 ' + paidSubCount + '/' + subCount + ')' : ''}}</div>
                            </div>
                            <div class="org-card-incentive ${{isPaid ? 'paid' : 'unpaid'}}">${{mgrAmount.toLocaleString()}} VND</div>
                            <span class="org-card-toggle">${{subCount > 0 ? '▼' : ''}}</span>
                        </div>
                        ${{subCount > 0 ? '<div class="org-subordinates">' : ''}}
                `;
                ...
                subordinates.forEach(sub => {{
                    ...
                    html += `
                            <div class="org-subordinate-item" onclick="event.stopPropagation(); showEmployeeDetail('${{subNo}}')">
        ...
        function generateEmployeeTable() {{
            ...
            employeeData.forEach(emp => {{
                ...
                // 🔧 모바일 카드 뷰 생성 (2025-12-19 추가, 2025-12-19 번역 키 수정)
                if (cardContainer) {{
                    const prevMonthAmount = parseInt(emp['{prev_month_name}_incentive'] || emp.previous_incentive || emp.august_incentive || 0);
                    const statusText = isPaid ? '✅ ' + getTranslation('status.paid') : '❌ ' + getTranslation('status.unpaid');
                    // 🔧 수정된 번역 키 (mobileCard.* 사용)
                    const prevMonthLabel = getTranslation('mobileCard.prevMonth') || '지난달';
                    const currentMonthLabel = getTranslation('mobileCard.currentMonth') || '이번달';
                    const positionLabel = getTranslation('mobileCard.position') || '직급';
                    const empIdLabel = getTranslation('mobileCard.employeeId') || '사번';
                    const statusLabel = getTranslation('mobileCard.status') || '상태';

                    const cardHTML = `
                        <div class="employee-card ${{isPaid ? '' : 'unpaid'}}" onclick="showEmployeeDetail('${{empNo}}')">
                            <div class="emp-header">
                                <span class="emp-name">${{empName}}${{emp.Talent_Pool_Member === 'Y' ? ' <span class="talent-pool-badge">🌟 TALENT</span>' : ''}}</span>
                                <span class="type-badge type-${{empType.toLowerCase().replace('type-', '')}}">${{empType}}</span>
                            </div>
                            <div class="emp-info-row">
                                <span class="emp-label">${{empIdLabel}}</span>
                                <span class="emp-value">${{empNo}}</span>
                            </div>
                            <div class="emp-info-row">
                                <span class="emp-label">${{positionLabel}}</span>
                                <span class="emp-value">${{empPosition}}</span>
                            </div>
                            <div class="emp-info-row">
                                <span class="emp-label">${{prevMonthLabel}}</span>
                                <span class="emp-value">${{prevMonthAmount.toLocaleString()}} VND</span>
                            </div>
                            <div class="emp-info-row">
                                <span class="emp-label">${{currentMonthLabel}}</span>
                                <span class="emp-value incentive-amount ${{isPaid ? 'paid' : 'unpaid'}}">${{amount.toLocaleString()}} VND</span>
                            </div>
                            <div class="emp-info-row">
                                <span class="emp-label">${{statusLabel}}</span>
                                <span class="emp-value">${{statusText}}</span>
                            </div>
                        </div>
                    `;
        ...
        function initMobileBottomNav() {{
            ...
            navItems.forEach(item => {{
                item.addEventListener('click', function(e) {{
                    ...
                    if (targetTab) {{
                        showTab(targetTab);
                        updateBottomNavActive(targetTab);
                    }}
                }});
            }});
        }}
        ...
        // 모바일 모드 변경 시 스와이프 초기화
        const originalSwitchViewMode = typeof switchViewMode === 'function' ? switchViewMode : null;
        if (originalSwitchViewMode) {{
            window.switchViewMode = function(mode) {{
                originalSwitchViewMode(mode);
                if (mode === 'mobile') {{
                    initSwipeGestures();
                }}
            }};
    ...
    <nav id="mobileBottomNav" class="mobile-bottom-nav">
        <a href="#" class="nav-item active" data-tab="summary">
            <span class="nav-icon">📊</span>
            <span class="nav-text" data-i18n="nav.summary">요약</span>
        </a>
        <a href="#" class="nav-item" data-tab="individual">
            <span class="nav-icon">👤</span>
            <span class="nav-text" data-i18n="nav.individual">개인별</span>
        </a>
        <a href="#" class="nav-item" data-tab="incentive">
            <span class="nav-icon">💰</span>
            <span class="nav-text" data-i18n="nav.incentive">기준</span>
        </a>
        ...
        <a href="#" class="nav-item" data-tab="faq">
            <span class="nav-icon">❓</span>
            <span class="nav-text" data-i18n="nav.faq">FAQ</span>
        </a>
    </nav>
</body>
</html>'''
