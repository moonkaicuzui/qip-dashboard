            ...
            <div id="criteria" class="tab-content">
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <h6 style="color: #667eea; font-weight: 600;" class="mb-3 mt-4">TYPE-2 직급별 조건</h6>
                        ...
                        <h6 style="color: #667eea; font-weight: 600;" class="mb-3 mt-4">TYPE-3 직급별 조건</h6>
                        <table class="table table-sm table-hover" style="border: 1px solid #e0e0e0;">
                            <thead style="background-color: #f8f9fa; color: #333; border-bottom: 2px solid #667eea;">
                                <tr>
                                    <th>직급</th>
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <!-- TYPE-1 인센티브 테이블 -->
                        <h6 style="color: #667eea; font-weight: 600;" class="mb-3">TYPE-1 직급별 인센티브 계산 방법 및 실제 예시</h6>
                        <table class="table table-sm table-hover mb-4" style="border: 1px solid #e0e0e0;">
                            ...
                            <tbody>
                                ...
                                <tr style="background-color: #fff3e0;">
                                    ...
                                    <td><strong>Part1 + Part2 + Part3 특별 계산</strong><br>
                                        <div style="margin-top: 8px;"><strong>Part 1: AQL 평가 결과</strong></div>
                                        <small>Level-A 1개월: 150,000 | 2개월: 250,000<br>
                                        3개월: 300,000 | 4개월: 350,000<br>
                                        5개월: 400,000 | 6개월: 450,000<br>
                                        7개월: 500,000 | 8개월: 650,000<br>
                                        9개월: 750,000 | 10개월: 850,000<br>
                                        11개월: 950,000 | 12개월+: 1,000,000</small><br>
                                        <div style="margin-top: 8px;"><strong>Part 2: CFA 자격증</strong></div>
                                        <small>CFA 자격증 보유시: 700,000</small><br>
                                        <div style="margin-top: 8px;"><strong>Part 3: HWK 클레임 방지</strong></div>
                                        <small>1개월: 100,000 | 2개월: 200,000<br>
                                        3개월: 300,000 | 4개월: 400,000<br>
                                        5개월: 500,000 | 6개월: 600,000<br>
                                        7개월: 700,000 | 8개월: 800,000<br>
                                        9개월+: 900,000</small></td>
                        ...
                        <h6 style="color: #667eea; font-weight: 600;" class="mb-3">TYPE-1 ASSEMBLY INSPECTOR 연속 근무 인센티브</h6>
                        <table class="table table-sm table-hover mb-4" style="border: 1px solid #e0e0e0;">
                            <thead style="background-color: #f8f9fa; color: #333; border-bottom: 2px solid #667eea;">
                                <tr>
                                    <th>연속 목표 달성 개월</th>
                            ...
                            <tbody>
                                ...
                                <tr style="background-color: #e8f5e9; font-weight: bold;"><td>12개월 이상</td><td>1,000,000</td></tr>
                            </tbody>
                        </table>
                        
                        <!-- TYPE-2 인센티브 계산 방법 -->
                        <h6 style="color: #667eea; font-weight: 600;" class="mb-3">TYPE-2 전체 직급 인센티브 계산 방법</h6>
                        ...
                        <!-- TYPE-3 인센티브 -->
                        <h6 style="color: #667eea; font-weight: 600;" class="mb-3">TYPE-3 신입 직원 인센티브</h6>
                        <table class="table table-sm table-hover mb-4" style="border: 1px solid #e0e0e0;">
                            <thead style="background-color: #f8f9fa; color: #333; border-bottom: 2px solid #667eea;">
                                <tr>
                                    <th>구분</th>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-light">
                            ...
                            <p><strong>담당 구역:</strong> Building B </p>
                            <p><strong>Building B 구역 생산 총 AQL 검사 PO 수량: 100개)</strong></p>
                            <p><strong>Building B 구역 생산 총 AQL 리젝 PO 수량: 2개)</strong></p>
                            <p><strong>계산:</strong> 2 / 100 × 100 = 2%</p>
                            <p><strong>결과:</strong> ✅ 2% < 3% → <span class="badge bg-success">조건 충족</span></p>
                        </div>
                        
                        <h6 class="text-primary mb-3 mt-4">AUDIT & TRAINING TEAM 멤버별 담당 구역</h6>
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>전체</td>
                                        <td>Team Leader - 전체 Building 총괄</td>
                            ...
                            <p class="text-muted small mt-2">
                                * Reject율 기준: 3% 미만 (✅ 충족, ❌ 미충족)<br>
                                * 8월 기준 모든 AUDIT & TRAINING TEAM 멤버가 reject율 조건 미충족으로 인센티브 0원
                            </p>
                        </div>
                        
                        <h6 class="text-primary mb-3 mt-4">예시 3: TYPE-2 STITCHING INSPECTOR</h6>
                        <div class="alert alert-light">
                            <p><strong>직원:</strong> PHẠM THỊ HOA (STITCHING INSPECTOR)</p>
                            <p><strong>직급 타입:</strong> TYPE-2</p>
                            <p><strong>조건 충족 현황:</strong></p>
                            <ul>
                                <li>✅ 출근율: 95% (≥88% 충족)</li>
                                <li>✅ 무단결근: 0일 (≤2일 충족)</li>
                                <li>✅ 실제근무일: 19일 (>0일 충족)</li>
                                <li>✅ 최소근무일: 19일 (≥12일 충족)</li>
                            </ul>
                            <p><strong>인센티브 계산:</strong></p>
                            <p>TYPE-2 STITCHING INSPECTOR는 출근 조건(1-4번)만 확인하며, 모든 조건을 충족했으므로 기본 인센티브를 받습니다.</p>
                            <p><strong>지급액:</strong> 150,000 VND (TYPE-2 기본 인센티브)</p>
                            <p class="text-muted">* TYPE-2는 AQL이나 5PRS 조건 없이 출근 조건만으로 인센티브가 결정됩니다.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="formula-box p-3 bg-light rounded mb-3">
                            <h6>결근율 계산 예시:</h6>
                            <div class="alert alert-light">
                                <strong>예시 1: 정상 근무자</strong><br>
                                • 총 근무일: 27일<br>
                                • 실제 근무일: 25일<br>
                                • 승인된 휴가: 2일 (연차)<br>
                                • 결근 일수: 27 - 25 - 2 = 0일<br>
                                • 결근율: (0 / 27) × 100 = <strong>0%</strong><br>
                                • 출근율: 100 - 0 = <strong>100%</strong> ✅
                            </div>
                            <div class="alert alert-light">
                                <strong>예시 2: 무단결근 포함</strong><br>
                                • 총 근무일: 27일<br>
                                • 실제 근무일: 22일<br>
                                • 승인된 휴가: 1일 (병가)<br>
                                • 무단결근: 4일 (AR1)<br>
                                • 결근 일수: 27 - 22 - 1 = 4일<br>
                                • 결근율: (4 / 27) × 100 = <strong>14.8%</strong><br>
                                • 출근율: 100 - 14.8 = <strong>85.2%</strong> ❌ (88% 미만)
                            </div>
                            <div class="alert alert-light">
                                <strong>예시 3: 조건 충족 경계선</strong><br>
                                • 총 근무일: 27일<br>
                                • 실제 근무일: 24일<br>
                                • 승인된 휴가: 0일<br>
                                • 무단결근: 3일 (AR1)<br>
                                • 결근 일수: 27 - 24 - 0 = 3일<br>
                                • 결근율: (3 / 27) × 100 = <strong>11.1%</strong><br>
                                • 출근율: 100 - 11.1 = <strong>88.9%</strong> ✅ (88% 이상)<br>
                                • 단, 무단결근 3일로 조건 2 미충족 → 인센티브 0원
                            </div>
                        </div>
