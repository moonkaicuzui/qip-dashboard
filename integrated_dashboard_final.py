        ...
        function generateEmployeeTable() {{
            ...
            employeeData.forEach(emp => {{
                ...
                if (cardContainer) {{
                    ...
                    const prevMonthLabel = getTranslation('individual.table.columns.prevMonth', currentLanguage) || '지난달';
                    const currentMonthLabel = getTranslation('individual.table.columns.currentMonth', currentLanguage) || '이번달';
                    const positionLabel = getTranslation('individual.table.columns.position', currentLanguage) || '직급';
                    const empIdLabel = getTranslation('individual.table.columns.id', currentLanguage) || '사번';
