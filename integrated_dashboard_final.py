            ...
            <div id="criteria" class="tab-content">
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <h6 style="color: #667eea; font-weight: 600;" class="mb-3">AQL INSPECTOR 특별 계산 방법 (TYPE-1)</h6>
                        <div class="alert" style="background-color: #fff3e0; border-left: 4px solid #ff9800; color: #333;" class="mb-3">
