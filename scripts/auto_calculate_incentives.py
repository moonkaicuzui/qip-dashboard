...
def calculate_incentive(month_str, year):
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            # V10.0 → V9.1 → V9.0 → V8.02 순서로 확인 - 통일된 fallback 패턴 (2026-01-06)
            csv_pattern_v10 = f"output_files/output_QIP_incentive_{month_str}_{year}_Complete_V10.0_Complete.csv"
            ...
            csv_files = glob.glob(csv_pattern_v10) or glob.glob(csv_pattern_v91) or glob.glob(csv_pattern_v9) or glob.glob(csv_pattern_v8)
