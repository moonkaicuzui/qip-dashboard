...
<head>
                        ...
                        <table class="table table-hover">
                            <thead class="unified-table-header">
                                <tr>
                                    ...
                                    <th class="sortable-header ${sortColumn === 'name' ? sortOrder : ''}" onclick="window.zeroModalSort('name')">${{translations.common?.tableHeaders?.name?.[lang] || '이름'}}</th>
                    ...
                    <table class="table table-hover" id="minimumDaysTable" style="font-size: 14px;">
                        <thead class="unified-table-header">
                            <tr>
                                ...
                                <th class="sortable-header" data-sort="name" onclick="window.minDaysSort('name')" style="min-width: 130px;">${{translations.common?.tableHeaders?.name?.[lang] || '이름'}}</th>
                                ...
                                <table class="table table-hover" style="font-size: 14px;">
                                    <thead class="unified-table-header">
                                        <tr>
                                            ...
                                            <th class="sortable-header" data-sort="name" style="min-width: 130px; padding: 12px; cursor: pointer;">${{translations.common?.tableHeaders?.name?.[lang] || '이름'}} ${getSortIcon('name')}</th>
    ...
    function showConsecutiveAqlFailDetails() {
        ...
        if (threeMonthFails.length === 0) {
            ...
            modalHTML += '<th style="border: 1px solid #dee2e6; padding: 8px;">${{translations.common?.tableHeaders?.name?.[lang] || '이름'}}</th>';
                                ...
                                <table class="table table-hover">
                                    <thead class="unified-table-header">
                                        <tr>
                                            ...
                                            <th class="sortable-header" data-sort="name">${{translations.common?.tableHeaders?.name?.[lang] || '이름'}} ${getSortIcon('name')}</th>
...
<body>
    <div class="container">
        ...
        <div class="content p-4">
            ...
            <div class="tabs">
                ...
                <div class="tab" data-tab="validation" onclick="showTab('validation')" id="tabValidation">${{translations.tabs?.validation?.[lang] || '요약 및 시스템 검증'}}</div>
            </div>
    ...
    html_content += f'''
                    ...
                    <table class="table" id="employeeTable">
                        <thead>
                            <tr>
                                ...
                                <th id="nameHeader">${{translations.common?.tableHeaders?.name?.[lang] || '이름'}}</th>
                            ...
                            <tbody>
                                ...
                                <tr style="background-color: #fff3e0;">
                                    ...
                                    <td><span class="calc-example-employee" data-employee="618110077">예시: 618110077 직원</span><br>
                                        ...
                                        <span class="calc-total-label">${{translations.orgChartModal?.total?.[lang] || '합계'}}</span>: 2,600,000 VND</td>
                                </tr>
                    ...
                    <div class="card-body">
                        ...
                        <div id="orgChartContainer" class="collapsible-tree">
                            ...
                            <div class="org-header">
                                <h4 id="orgChartTitle">${{translations.orgChart?.type1ManagerStructure?.[lang] || 'TYPE-1 관리자 인센티브 구조'}}</h4>
        ...
        <div id="validation" class="tab-content">
            <h3 id="validationTabTitle">${{translations.tabs?.validation?.[lang] || '요약 및 시스템 검증'}}</h3>
    ...
    <script>
        ...
        // 인센티브 ${{translations.orgChartModal?.receivingStatus?.[lang] || '수령 여부'}} 확인 함수
        ...
        window.showIncentiveModal = function(nodeId) {{
            ...
            try {{
                ...
                // ${{translations.orgChartModal?.calculationDetails?.[lang] || '계산 과정 상세'}} 내용 생성
                            ...
                            <table class="table table-sm table-bordered">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th>ID</th>
                                        <th class="text-end">${{translations.orgChartModal?.incentive?.[lang] || '인센티브'}}</th>
                                        <th class="text-center">${{translations.orgChartModal?.receivingStatus?.[lang] || '수령 여부'}}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <tfoot class="table-secondary">
                                    <tr>
                                        <th colspan="2">${{translations.orgChartModal?.total?.[lang] || '합계'}}</th>
                ...
                calculationDetails = `
                    <div class="calculation-details">
                        <h6>📊 ${{translations.orgChartModal?.calculationDetails?.[lang] || '계산 과정 상세'}} (LINE LEADER)</h6>
                        <table class="table table-sm">
                            <tr>
                                <td>계산 공식:</td>
                            ...
                            <tr>
                                <td>${{translations.orgChartModal?.calculationFormula?.[lang] || '계산식'}}:</td>
                            ...
                            <table class="table table-sm table-bordered">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th>ID</th>
                                        <th class="text-end">${{translations.orgChartModal?.incentive?.[lang] || '인센티브'}}</th>
                                        <th class="text-center">${{translations.orgChartModal?.includeInAverage?.[lang] || '평균 계산 포함'}}</th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                calculationDetails = `
                    <div class="calculation-details">
                        <h6>📊 ${{translations.orgChartModal?.calculationDetails?.[lang] || '계산 과정 상세'}} (GROUP LEADER)</h6>
                        <table class="table table-sm">
                            <tr>
                                <td>계산 공식:</td>
                            ...
                            <tr>
                                <td><span class="modal-team-line-leader-count">${{translations.orgChartModal?.teamLineLeaderCount?.[lang] || '팀 내 LINE LEADER 수'}}:</span></td>
                                <td class="text-end">${{teamLineLeaders.length}}명 (수령: ${{receivingLineLeaders.length}}명)</td>
                            </tr>
                            <tr>
                                <td>${{translations.orgChartModal?.lineLeaderAverage?.[lang] || 'LINE LEADER 평균 인센티브'}}:</td>
                    ...
                    allLineLeaderDetails = `
                        <div class="mt-3">
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tfoot class="table-secondary">
                                    <tr>
                                        <th colspan="3">${{translations.orgChartModal?.total?.[lang] || '합계'}}</th>
                                        <th class="text-end">₫${{receivingLineLeaders.reduce((sum, ll) => sum + Number(ll[dashboardMonth + '_incentive'] || 0), 0).toLocaleString('ko-KR')}}</th>
                                        <th></th>
                                    </tr>
                                    <tr>
                ...
                calculationDetails = `
                    <div class="calculation-details">
                        <h6>📊 ${{translations.orgChartModal?.calculationDetails?.[lang] || '계산 과정 상세'}} (SUPERVISOR)</h6>
                        <table class="table table-sm">
                            <tr>
                                <td>계산 공식:</td>
                ...
                calculationDetails = `
                    <div class="calculation-details">
                        <h6>📊 ${{translations.orgChartModal?.calculationDetails?.[lang] || '계산 과정 상세'}} (A.MANAGER)</h6>
                        <table class="table table-sm">
                            <tr>
                                <td>계산 공식:</td>
                ...
                calculationDetails = `
                    <div class="calculation-details">
                        <h6>📊 ${{translations.orgChartModal?.calculationDetails?.[lang] || '계산 과정 상세'}} (MANAGER)</h6>
                        <table class="table table-sm">
                            <tr>
                                <td><span class="modal-team-line-leader-count">${{translations.orgChartModal?.teamLineLeaderCount?.[lang] || '팀 내 LINE LEADER 수'}}:</span></td>
                            ...
                            <tr>
                                <td>${{translations.orgChartModal?.lineLeadersReceiving?.[lang] || '인센티브 받은 LINE LEADER'}}:</td>
                            ...
                            <tr class="table-warning">
                                <td><strong>${{translations.orgChartModal?.calculationFormula?.[lang] || '계산식'}}:</strong></td>
                        ...
                        <div class="modal-content" style="z-index: 1057; position: relative; user-select: text; -webkit-user-select: text; -moz-user-select: text; -ms-user-select: text;">
                            ...
                            <div class="modal-body">
                                <div class="employee-info mb-3">
                                    <h5>${{employee.name}}</h5>
                                    <p class="mb-1"><strong>${{translations.orgChartModal?.position?.[lang] || '직급'}}:</strong> ${{employee.position}}</p>
            ...
            try {{
                ...
                node.append("rect")
                    ...
                    .attr("fill", d => {{
                        ...
                        // 인센티브 ${{translations.orgChartModal?.receivingStatus?.[lang] || '수령 여부'}}에 따라 색상 조정
                        if (hasIncentive(d.data)) {{
